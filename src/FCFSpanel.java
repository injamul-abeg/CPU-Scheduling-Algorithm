...
public class FCFSpanel extends JPanel {
	...
	public FCFSpanel() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				FcFshow.setData(ar, br, k);
				FcFshow fcfshow = new FcFshow();
				CPU_Schedueling.contentPane.add(fcfshow, "fcfshow");
				CPU_Schedueling.showPanel("fcfshow");
			}
