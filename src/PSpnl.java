...
public class PSpnl extends JPanel {
	...
	public PSpnl() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				PSpnlshow.setData(ar, br, k);
				PSpnlshow pshow = new PSpnlshow();
				CPU_Schedueling.contentPane.add(pshow, "PSshow");
				CPU_Schedueling.showPanel("PSshow");
			}
