...
public class SJFpanel extends JPanel {
	...
	public SJFpanel() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SJFshow.setData(ar, br, k);
				SJFshow sjfshow = new SJFshow();
				CPU_Schedueling.contentPane.add(sjfshow, "sjfshow");
				CPU_Schedueling.showPanel("sjfshow");
			}
...
//			}
//		});
//		btnNewButton_1.setBounds(246, 417, 89, 31);
//		add(btnNewButton_1);
